    ...
    >
              ...
              <List sx={{ gap: 0.5 }}>
                ...
                <ListItem sx={{ mt: 0.5 }}>
                  <ListItemButton>
                    <PetsIcon />
                    <ListItemContent>
                      <Link className={styles.link} href="/plans/myplans">
                  ...
                  <ListItemButton>
                    ...
                    <ListItemContent>
                      <Link className={styles.link} href="/payments">
                        <Typography level="title-sm">My Payments</Typography>
                      </Link>
                    </ListItemContent>
                  </ListItemButton>
                </ListItem>
            ...
            <Toggler
              renderToggle={({ open, setOpen }) => (
                <ListItemButton onClick={() => setOpen(!open)}>
                  <AttachMoneyIcon />
                  <ListItemContent>
                    <Typography level="title-sm">Diseases</Typography>
                  </ListItemContent>
                  <KeyboardArrowDownIcon
                    sx={{ transform: open ? "rotate(180deg)" : "none" }}
                  />
              ...
              <List sx={{ gap: 0.5 }}>
                <ListItem sx={{ mt: 0.5 }}>
                  <ListItemButton>
                    <PaymentIcon />
                    <ListItemContent>
                      <Link className={styles.link} href="/diseases/flag">
                        <Typography level="title-sm">
                          Flaged Diseases
                        </Typography>
                      </Link>
                ...
                <ListItem sx={{ mt: 0.5 }}>
                  <ListItemButton>
                    <PaymentIcon />
                    <ListItemContent>
                      <Link className={styles.link} href="/diseases/flagged">
      ...
      <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
        <Avatar
          variant="outlined"
          size="sm"
          src="https://source.unsplash.com/64x64/?portrait"
        />
